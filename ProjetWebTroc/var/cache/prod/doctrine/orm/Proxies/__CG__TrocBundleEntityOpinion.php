 ...
 */
class Opinion extends \TrocBundle\Entity\Opinion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TrocBundle\\Entity\\Opinion' . "\0" . 'idOp', '' . "\0" . 'TrocBundle\\Entity\\Opinion' . "\0" . 'contenu', '' . "\0" . 'TrocBundle\\Entity\\Opinion' . "\0" . 'note', '' . "\0" . 'TrocBundle\\Entity\\Opinion' . "\0" . 'idUser'];
        }
