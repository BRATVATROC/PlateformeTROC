...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'usernom', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'userprenom', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'usercin', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'useradresse', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'userphone', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'userimage', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
