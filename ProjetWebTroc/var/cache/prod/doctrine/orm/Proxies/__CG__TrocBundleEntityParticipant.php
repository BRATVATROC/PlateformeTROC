 ...
 */
class Participant extends \TrocBundle\Entity\Participant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TrocBundle\\Entity\\Participant' . "\0" . 'id', '' . "\0" . 'TrocBundle\\Entity\\Participant' . "\0" . 'idUser', '' . "\0" . 'TrocBundle\\Entity\\Participant' . "\0" . 'idEvent'];
        }
