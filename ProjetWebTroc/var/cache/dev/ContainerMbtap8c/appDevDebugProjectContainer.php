...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('C3isSpoEQE', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GGr1Jxtaye', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Kur-201K1q', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('txt-lygRx-', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7QKNm-pAF8', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), '!FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\TrocBundle/Resources/views'), 'Troc');
        $instance->addPath(($this->targetDirs[3].'\\src\\TrocBundle/Resources/views'), '!Troc');
        $instance->addPath(($this->targetDirs[3].'\\src\\AnnonceBundle/Resources/views'), 'Annonce');
        $instance->addPath(($this->targetDirs[3].'\\src\\AnnonceBundle/Resources/views'), '!Annonce');
        $instance->addPath(($this->targetDirs[3].'\\src\\ItemsBundle/Resources/views'), 'Items');
        $instance->addPath(($this->targetDirs[3].'\\src\\ItemsBundle/Resources/views'), '!Items');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'TrocBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\TrocBundle'),
                ...
                'AnnonceBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\AnnonceBundle'),
                    'namespace' => 'AnnonceBundle',
                ),
                'ItemsBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ItemsBundle'),
                    'namespace' => 'ItemsBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
            ...
            case 'image_dir': $value = ($this->targetDirs[3].'/web/upload'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TrocBundle' => 'TrocBundle\\TrocBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'AnnonceBundle' => 'AnnonceBundle\\AnnonceBundle',
                'ItemsBundle' => 'ItemsBundle\\ItemsBundle',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'nadia.boudhief@esprit.tn' => 'Nadia',
            ),
