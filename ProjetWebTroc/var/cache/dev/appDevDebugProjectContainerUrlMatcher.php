...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/annonce')) {
            ...
            if (0 === strpos($pathinfo, '/annonce/s')) {
                // annonce_show
                ...
                // annonce_search
                if ('/annonce/search' === $pathinfo) {
                    return array (  '_controller' => 'AnnonceBundle\\Controller\\AnnonceController::searchAction',  '_route' => 'annonce_search',);
                }
