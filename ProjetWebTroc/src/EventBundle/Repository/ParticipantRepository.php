...
class ParticipantRepository extends \Doctrine\ORM\EntityRepository
{
    ...
    public function findByParticipant($idU, $idE)
    {
        $query =$this->getEntityManager()->createQuery("SELECT p.id FROM EventBundle:Participant p WHERE p.idUser ='$idU' AND p.idEvent='$idE'");
        return $query->getResult();
    }
