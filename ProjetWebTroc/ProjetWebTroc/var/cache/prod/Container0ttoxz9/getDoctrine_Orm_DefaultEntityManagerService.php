...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\TrocBundle\\Entity')));

$b->addDriver($c, 'AppBundle\\Entity');
$b->addDriver($c, 'TrocBundle\\Entity');
...
$a->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'TrocBundle' => 'TrocBundle\\Entity'));
